...
public class tv_menu_touming extends Activity 
{
	...
	protected void onCreate(Bundle savedInstanceState) 
	{
       ...
       // this.setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_LANDSCAPE);   
		...
		setContentView(R.layout.tv_menu_dialog);
...
//							intent.setClass(tv_menu_touming.this, .class);
//							//清除其他activity
